...
module.exports.run = async (bot, message, args) => {
      ...
      my_index = obj["Users"].findIndex(user => user.ID === message.author.id);
      temp_index = my_index;
      ...
      top_text = "";
      title_text = `Вы на ${obj["Users"].findIndex(user => user.ID === message.author.id)+1} месте`;
      for(i = my_index; i < 10+my_index && i < obj["Users"].length; i++)
      {
